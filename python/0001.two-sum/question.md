...
<p>You may assume that each input would have <strong><em>exactly</em> one solution</strong>, and you
may not use the <em>same</em> element twice.</p>
...
than&nbsp;<code>O(n<sup>2</sup>)&nbsp;</code>time complexity?
